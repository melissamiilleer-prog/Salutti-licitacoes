...
Conteúdo do site: abertura (hero) + Serviços + Metodologia +
Oportunidades no mercado público + Quem Somos + Contato.
...
- `index.html` — todo o conteúdo (Hero, Serviços, Metodologia, Oportunidades, Quem Somos, Contato).
- `styles.css` — todo o visual (cores, tipografia, layout).
- `script.js` — menu mobile e o botão de WhatsApp do formulário de contato.
- `assets/` — logo (`logo-wide.png`, usada no site; `logo.png`/`logo.jpeg`, usadas como ícone/favicon), foto de abertura (`hero.jpg`) e foto da seção de Serviços (`licitacoes.jpg`).
