...
Conteúdo do site (versão enxuta): abertura (hero) + Oportunidades no
mercado público + Quem Somos (O que somos / Onde atuamos / Por que
atuamos / Resultado que esperamos) + contato.
...
- `index.html` — todo o conteúdo (Hero, Oportunidades, Quem Somos, Contato).
